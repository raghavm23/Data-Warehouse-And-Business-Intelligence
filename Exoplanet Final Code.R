...
m <- read.csv("/Users/Raghav/Desktop/RxM/MSc DA/Semester 2/ADM (H9ADM)/Project/Dataset/kepler-labelled-time-series-data/exoTrain.csv", stringsAsFactors = F)
n = read.csv("/Users/Raghav/Desktop/RxM/MSc DA/Semester 2/ADM (H9ADM)/Project/Dataset/kepler-labelled-time-series-data/exoTest.csv", stringsAsFactors = F)
new1 = rbind(m,n)
